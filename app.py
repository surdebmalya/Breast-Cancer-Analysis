# Created By Debmalya Sur [28-07-2020] [14:21]
...
st.markdown(
    "<h1 style='text-align: center; color: Green;'><u>Breast Cancer Prediction</u></h1>",
...
st.markdown("This project is made by <a href='https://www.linkedin.com/in/debmalya-sur-9a36a218b/' target='_blank'><b>Debmalya Sur</b></a>", unsafe_allow_html=True)
...
if predict:
    ...
    try:
        ...
        prediction = classifier.predict(x_input_df.iloc[:1, :])
